# Power BI Skills — Índice

> **Repositório de skills.** Este arquivo na raiz é um índice. A skill canônica está em `skills/pbi-mcp/SKILL.md`.

## Skills

| Skill | Pasta | Descrição |
|-------|-------|-----------|
| pbi-mcp | `skills/pbi-mcp/` | Criar/editar medidas Power BI via MCP (Model Context Protocol) |

> Para uso via agente ou terminal, leia `skills/pbi-mcp/SKILL.md` (conteúdo completo abaixo, mantido para compatibilidade).
